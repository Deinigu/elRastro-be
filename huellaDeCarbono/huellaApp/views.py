...
def huellaDeCarbono(request, idUsuario1, idUsuario2):
    if request.method == 'GET':
        url1 = 'https://13.38.223.212:8000/api/usuarios/' + idUsuario1 + '/'
        url2 = 'https://13.38.223.212:8000/api/usuarios/' + idUsuario2 + '/'
...
def getCoordenadas(request, idUsuario):
    if request.method == 'GET':
        url1 = 'https://13.38.223.212:8000/api/usuarios/' + idUsuario + '/'
