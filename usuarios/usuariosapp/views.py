...
def compradores_usuario_view(request, usuario_id):
    ...
    if request.method == 'GET':
        url_productos = f'https://13.38.223.212:8001/api/productos/anteriores/{usuario_id}'
        ...
        if response_productos.status_code == 200:
            ...
            for producto in productos:
                url_puja = f'https://13.38.223.212:8002/api/pujas/ultima_puja/producto/{str(producto["_id"])}'
